...
public class RynMenuScreen extends Screen {
	static final int WORLD_DIM   = 0xC8000000;
	static final int PANEL_BOX   = 0xFF17171F;
	static final int PANEL       = 0xFF1E1E28;
	static final int CARD        = 0xFF212130;
	...
	public void extractRenderState(GuiGraphicsExtractor ctx, int mouseX, int mouseY, float delta) {
		...
		ctx.fill(px, py, px + pw, py + 2, ACCENT);
